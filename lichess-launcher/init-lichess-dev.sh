...
tmux new-session -d -s my_session "cd '$LILA_DIR'; echo 'Command: ./lila.sh'; bash"
tmux setw remain-on-exit on
tmux split-window -h "cd '$LILA_DIR'; echo 'Command: ui/build -w'; bash"
tmux split-window -v "cd '$LILA_DIR'; echo 'Command: redis-server'; bash"
